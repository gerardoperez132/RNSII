		...
		<div id="sombra">
			...
			<div id="container">
				...
				<div id="content2">
								...
								<table>
									...
									<tr>
										...
										<td>
											...
											<span><s:text name="mailHelp" /></span>
										   </a>
										</td>
									</tr>						
									<tr>
					...
					<s:elseif test="datosEnviados==true">
					...
					<s:elseif test="recoveryPassForm == true">
						...
						<form action="cambiarClave" method="post" id="formModificarClave" name="modificarClave">
						<table style=" margin-left: 20px;">
							...
							<tr>
								<td colspan="4">
									<s:token name="token" />
									<s:hidden name="cuenta"></s:hidden>							
									<input type="submit" id="cambiar_clave" value="<s:text name="usuario.modificar.clave"></s:text>">
								</td>						
							<tr>
						</table>
						</form>	
