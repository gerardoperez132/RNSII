		...
		<div class="container">
				...
				<div id="content">
					...
					<div class="main">
						...
						<br><br>
						<h1>Un error inesperado se ha producido.</h1>
						<h3>Por favor, informe de este error al administrador del sistema o al personal competente en soporte técnico.</h3>
			...
			<div class="vacio"></div>
			<%@include file="layout/footer_ge.jsp"%>SW				
	</body>
</s:i18n>
</html>