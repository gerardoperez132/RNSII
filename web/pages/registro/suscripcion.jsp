...
<script type="text/javascript" src="res/js/suscripcion.js"
	charset="UTF-8"></script>
<script type="text/javascript" src="res/js/tabs.js" charset="UTF-8"></script>
<script type="text/javascript" src="res/js/jquery.treeTable.js"
	charset="UTF-8"></script>
...
Lista de suscriciones pendientes -->
						...
						<table class="results">
							<tr>
								<th colspan="5"><s:text name="listaSolicitudesSuscripcion" />
								</th>
							</tr>
							<tr>
							...
							<s:iterator value="solicitudes">
								<tr>
									<td><s:property value="servicio" /></td>
									<td><s:property value="ente" /></td>
									<td align="center"><s:date name="fecha_creado"
											format="d'/'MM'/'yyyy" /></td>
									<td>
										<form action="examinarSolicitud" method="post">
											<s:hidden value="%{id_suscripcion}"
												name="id_solicitud_suscripcion" />
											<input type="submit" value="<s:text name="detalles"/>">
										</form>
									</td>
									<td></td>
...
Muestra los detalles de una solicitud de suscripción aprobarRechasar-->
						<table class="results">
							<tr>
								<th colspan="2"><s:text name="peticion_suscripcion" /></th>
							</tr>
							<tr>
							...
							<tr>
								<th colspan="2"><s:text name="datos_solicitud" /></th>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="alt2"><s:property
										value="solicitud.motivo_solicitante" /></td>
							</tr>
							<tr>
								<th colspan="2">
									<form action="preparar_AprobarRechasarSuscripcion"
										method="post">
										<s:hidden value="%{solicitud.id_solicitud_suscripcion}"
											name="id_solicitud_suscripcion" />
										<input type="submit"
											value="<s:text name="aceptarRechazarSuscripcion"/>">
									</form>
								</th>
							</tr>
						</table>
...
Formulario para dar el dictamen de una solicitud de suscripción -->
						<form action="AprobarRechasarSuscripcion" method="post"
							name="dictamenForm">
							<table class="results">
								<tr>
									<th colspan="2"><s:text name="peticion_suscripcion" /></th>
							...
							<table class="results">
								<tr>
									<th colspan="3"><s:text name="veredicto_solicitud" /></th>
								</tr>
								<tr>
									<th colspan="3">
										<h5 class="requerido">
								...
								<tr>
									...
									<td class="alt2"><input type="radio"
										name="solicitud.sentencia" value="1"
										<s:if test="solicitud.sentencia == 1">checked</s:if> id="ops1" />
										<s:property value="sentencia[0]" /> <input type="radio"
										name="solicitud.sentencia" value="2"
										<s:if test="solicitud.sentencia == 2">checked</s:if> id="ops2" />
										<s:property value="sentencia[1]" /></td>
									<td class="alt2"><h5 id="m_sentencia" class="requerido">
											*
											<s:fielderror>
												<s:param>sentencia</s:param>
											</s:fielderror>
										</h5></td>
								</tr>
								<tr>
									<td class="alt"><s:text name="motivo_proveedor" /></td>
									<td class="alt2"><s:textarea
											name="solicitud.motivo_proveedor" rows="6" cols="19"
											id="motivo" /></td>
									<td class="alt2"><h5 id="m_motivo" class="requerido">
											*
											<s:fielderror>
												<s:param>motivo_proveedor</s:param>
											</s:fielderror>
										</h5></td>
								</tr>
								<tr>
									<th colspan="3"><input type="submit"
										value="<s:text name='enviar'/>" id="sentenciar"></th>
								</tr>
							</table>
...
Lista con las respuestas a las solicitudes de suscripción a servicios de información de otros entes -->
						<table class="results">
							<tr>
								<th colspan="5"><s:text name="listaSolicitudesRespuesta" />
								</th>
							</tr>
							<tr>
								<th><s:text name="servicio_solicitado" /></th>
							...
							<s:if test="solicitudesRespondidas.size() > 0">
								<s:iterator value="solicitudesRespondidas">
									<tr>
										<td
											<s:if test="leido==false">style="text-transform: uppercase;font-weight: bold;"</s:if>>
										...
										<td
											<s:if test="leido==false">style="text-transform: uppercase;font-weight: bold;"</s:if>>
											<s:if test="sentencia==1">
												<s:text name="aprobado" />
											</s:if> <s:if test="sentencia==2">
												<s:text name="rechazado" />
											</s:if>
										</td>
										<td
											<s:if test="leido==false">style="text-transform: uppercase;font-weight: bold;"</s:if>>
							...
							<s:else>
								<tr>
									<td colspan="5"><s:text name="solicitudesRespondidasNull"></s:text>
									</td>
								</tr>
							</s:else>
						</table>
...
Muestra los detalles de una respuesta a una solicitud de suscripción-->
						<table class="results">
							<tr>
								<th colspan="2"><s:text name="detallesRespuestaSolicitud" />
								</th>
							</tr>
							<tr>
								<td class="alt"><s:text name="n_servicio" /></td>
							...
							<tr>
								...
								<td class="alt2"><s:date name="solicitud.fecha_modificado"
										format="d'/'MM'/'yyyy" /></td>
							</tr>
							<tr>
								<td class="alt"><s:text name="dictamen" /></td>
								<td class="alt2"><s:if test="solicitud.sentencia==1">
										<s:text name="aprobado" />
									</s:if> <s:if test="solicitud.sentencia==2">
										<s:text name="rechazado" />
									</s:if></td>
							</tr>
							<tr>
								<td class="alt"><s:text name="motivo_proveedor" /></td>
								<td class="alt2"><s:property
										value="solicitud.motivo_proveedor" /></td>
							</tr>
							<tr>
								<th colspan="2"><s:text name="datos_solicitud" /></th>
							</tr>
							...
							<tr>
								...
								<td class="alt2"><s:date name="solicitud.fecha_creado"
										format="d'/'MM'/'yyyy" /></td>
							</tr>
							<tr>
								<td class="alt"><s:text name="telefono" /></td>
					...
					<s:else>
						...
						<span class="ok_pass"> <s:actionmessage />
						</span>
					</s:else>
				</div>
