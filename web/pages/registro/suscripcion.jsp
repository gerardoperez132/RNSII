							...
							<table>
								...
								<tr>
									<td align="right"><s:fielderror>
										...
										</s:fielderror> <s:text name="cargo_solicitante" />
									</td>
									<td><input type="text" name="solicitud.cargo" id="cargo" />
									</td>
									<td><h5 class="requerido">*</h5>
									</td>
								</tr>
								<tr>
									<td align="right"><s:fielderror>
										...
										</s:fielderror> <s:text name="telefono" />
									</td>
									<td><s:select name="codigo" list="codigos" /><input
										type="text" name="solicitud.telefono" id="telefono" size="14"
										maxlength="7" />
									</td>
									<td id="mtel"><h5 class="requerido">*</h5>
									</td>
								</tr>
								<tr>
									<td align="right"><s:fielderror>
											<s:param>correo</s:param>
										</s:fielderror> <s:text name="correo" />
									</td>
									<td><input type="text" name="solicitud.correo" id="correo" />
									</td>
									<td><h5 class="requerido">*</h5>
									</td>
								</tr>
								<tr>
									<td align="right"><s:fielderror>
										...
										</s:fielderror> <s:text name="motivo_solicitud" />
									</td>
