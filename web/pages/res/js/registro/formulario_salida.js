...
$(document)
		.ready(
				function() {
					...
					$("#sub_guardar_salida").click(function() {
							...
							.validate(
									{
										...
										messages : {
											'salida.nombre' : {
												required : data['errores']['error.salida.nombre'],
												regexTitle : data['errores']['error.regex.title']
											},
											'salida.descripcion' : {
												required : data['errores']['error.salida.descripcion'],
					 ...
					 */
					$('#salida\\.longitud').keyup(
							function(e) {
								if ($("#salida\\.id_tipo_dato").val() == 4) {// decimales
									if ($.isNumeric($("#salida\\.longitud")
											.val()) == false) {
