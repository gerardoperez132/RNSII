...
$(document).ready(function() {
	...
	/*
	 * Creación de método para validar una expresión regular del tipo
	 * description, usada por el plugin jquery validator
	 */
	...
	$("#formFunc").validate({
		...
		messages : {
			'funcionalidad.nombre' : {
				required : data['errores']['error.funcionalidad.nombre'],
				regexTitle : data['errores']['error.regex.title']
			},
			'funcionalidad.descripcion' : {
				required : data['errores']['error.funcionalidad.descripcion'],
