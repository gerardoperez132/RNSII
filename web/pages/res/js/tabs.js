$(document).ready(function() {
	...
	$("ul.tabs li").click(function() {
		...
		$(this).addClass("active"); // Agrega la clase activa a la tab
		// seleccionada
		$(".tab_content").hide(); // Esconde todo el contenido de la tab
		var activeTab = $(this).find("a").attr("href"); // Encuentra el valor
		// del atributo href
		// para identificar la
		// tab activa + el
		// contenido
		$(activeTab).fadeIn(); // Agrega efecto de transición (fade) en el
		// contenido activo
		return false;
	});
});
