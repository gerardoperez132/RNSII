...
public class EnviarCorreo extends DAO{
	...
	public boolean send(String email,String asunto,String mensaje){
		String mail_smtp_host = error.getProperties().getProperty("mail_smtp_host");
		String mail_smtp_starttls_enable = error.getProperties().getProperty("mail_smtp_starttls_enable");
		String mail_smtp_port = error.getProperties().getProperty("mail_smtp_port");
		String mail_smtp_user = error.getProperties().getProperty("mail_smtp_user");
		String mail_smtp_auth = error.getProperties().getProperty("mail_smtp_auth");
        ...
        try
            {
                ...
                message.addRecipient(
                    ...
                    new InternetAddress(mail_smtp_user));
                message.addRecipient(
                    Message.RecipientType.TO,
                    new InternetAddress(email.toString()));
